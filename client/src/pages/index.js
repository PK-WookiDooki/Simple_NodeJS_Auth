...
export { default as PNF } from "./PageNotFound";
...
export { default as Blogs } from "./blogs/BlogsList";
export { default as CBlog } from "./blogs/CreateBlog";
export { default as BDetail } from "./blogs/BlogDetail";
